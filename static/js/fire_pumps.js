...
//   });
  ...
  function calculateTotal() {
    ...
    if (final >= initial) {
      ...
      document.getElementById("total_hours").value = "Invalid";
    }
  }
...
function setupEventListeners() {
  ...
  document.getElementById("model_number").addEventListener("change", autoFillFromEquipment);
}
...
//   return fetch("/api/fireEquipment")
//     .then(res => res.json())
//     .then(data => {
...
function calculateTotalTime() {
    ...
    const diffMinutes = stopTotalMinutes - startTotalMinutes;
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("stop_time")
        ?.addEventListener("input", calculateTotalTime);
